                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(i.companyLogo.isNotEmpty ? i.companyLogo : '🏢', style: const TextStyle(fontSize: 28)),
                        Container(
                    ...
                    const Spacer(),
                    Text(i.title, style: AppTextStyles.bodyLarge.copyWith(fontWeight: FontWeight.w900, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                    Text(i.companyName, style: AppTextStyles.caption.copyWith(color: AppColors.muted)),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        const Icon(Icons.flash_on_rounded, size: 14, color: AppColors.accent),
                        const SizedBox(width: 4),
                        Text('Top Match', style: AppTextStyles.label.copyWith(fontSize: 11, color: AppColors.accent)),
                      ],
                    ),
                  ],
                ),
