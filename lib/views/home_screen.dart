            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  internships.when(
                    data: (data) => _InternshipBlock(data),
                    loading: () => const _Skeleton(),
                    error: (_, __) =>
                        const Text("Unable to load internships"),
                  ),
...
class _InternshipBlock extends StatelessWidget {
  final List<Internship> data;
  const _InternshipBlock(this.data);
