...
class _VerificationScreenState extends ConsumerState<VerificationScreen> {
  ...
  Future<void> _checkVerification() async {
    ...
    if (success && mounted) {
      ...
      _cooldownTimer?.cancel();
      // We don't hardcode context.go('/home') here anymore.
      // The app_router.dart will automatically redirect the user to 
      // either /home or /company-home based on their role!
    }
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'We sent a verification link to your email address. Please click the link in your Gmail app to activate your account.',
            ...
            if (authState.error != null)
              Padding(
                ...
                child: Text(authState.error!, style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
              ),
            if (authState.successMessage != null)
              Padding(
                padding: const EdgeInsets.only(bottom: 16),
                child: Text(authState.successMessage!, style: const TextStyle(color: AppColors.success, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
              ),
